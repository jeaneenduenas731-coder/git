...
/** Operation Msg */
	...
	MSG_LED_MODE,
	MSG_LED_BRIGHTNESS,		//brightness,

	//AudioCore task
	//音效控制在AudioCore task中执行，对应msg需严格限制在MSG_EFFECTCONTROL_START和MSG_EFFECTCONTROL_END之间
	/*********************/MSG_EFFECTCONTROL_START,/*********************/
	MSG_EFFECT_SYNC,
	MSG_MUSIC_VOL_SYNC,
	MSG_MIC_VOL_SYNC,
...
//tws
	...
	//BIS
	MSG_LE_BIS_SRC_START,
	MSG_LE_BIS_SRC_STOP,
	MSG_LE_BIS_SNK_START,
	MSG_LE_BIS_SNK_STOP,
	//从机连上需要i2s in模式
	MSG_DEVICE_SERVICE_BIS_SLAVE_CONNECTED,
	MSG_DEVICE_SERVICE_BIS_SLAVE_DISCONNECT,
	//BQB
	MSG_A2DP_CONNECT,
	MSG_AVRCP_CONNECT,
	...
	//WIRELESS EVENT//CFG_WIRELESS_EN

	MSG_WIRELESS_EVENT,
	MSG_WIRELESS_REMATCH,
	MSG_WIRELESS_REMATCH2,
	MSG_WIRELESS_FCC,
	MSG_FLASH_BANKB_UPDATA,
	MSG_1TNR_PAIR_START,
	MSG_1TNR_PAIR_END,
	MSG_1TNR_PAIR_CLEAN,
	MSG_1TNR_PAIR_KEY,
	MSG_2TNR_PAIR,
	MSG_2T1R_RX_SAVE_FLASH,
	MSG_SOC_CAP_CAL_MODE,
	MSG_WIRELESS_DUTMODE,
	MSG_2T1R_RX_SEND_MULTI_CMD,
	MSG_EFFECT_DEFAULT,
	MSG_EFFECT_USR1,
	MSG_WIRELESS_EVENT_END,
