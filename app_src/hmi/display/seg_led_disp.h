...
#define LedPinGpioInit()	GPIO_PortAModeSet(LED_PIN1_BIT,0),\
							...
							GPIO_PortAOutDsSet(LED_PIN1_BIT,GPIO_OUTDS_8MA),\
							GPIO_PortAOutDsSet(LED_PIN2_BIT,GPIO_OUTDS_8MA),\
							GPIO_PortAOutDsSet(LED_PIN3_BIT,GPIO_OUTDS_8MA),\
							GPIO_PortAOutDsSet(LED_PIN4_BIT,GPIO_OUTDS_8MA),\
							GPIO_PortAOutDsSet(LED_PIN5_BIT,GPIO_OUTDS_8MA),\
							GPIO_PortAOutDsSet(LED_PIN6_BIT,GPIO_OUTDS_8MA),\
							GPIO_PortAOutDsSet(LED_PIN7_BIT,GPIO_OUTDS_8MA),\
...
//设置LED 各个引脚恒流源输入
#define LED_PIN1_IN_ON	GPIO_PortAPulldownSet(LED_PIN1_BIT , GPIO_PULLDOWN_3MA2)

#define LED_PIN2_IN_ON	GPIO_PortAPulldownSet(LED_PIN2_BIT , GPIO_PULLDOWN_3MA2)

#define LED_PIN3_IN_ON	GPIO_PortAPulldownSet(LED_PIN3_BIT , GPIO_PULLDOWN_3MA2)

#define LED_PIN4_IN_ON	GPIO_PortAPulldownSet(LED_PIN4_BIT , GPIO_PULLDOWN_3MA2)

#define LED_PIN5_IN_ON	GPIO_PortAPulldownSet(LED_PIN5_BIT , GPIO_PULLDOWN_3MA2)

#define LED_PIN6_IN_ON	GPIO_PortAPulldownSet(LED_PIN6_BIT , GPIO_PULLDOWN_3MA2)

#define LED_PIN7_IN_ON	GPIO_PortAPulldownSet(LED_PIN7_BIT , GPIO_PULLDOWN_3MA2)
