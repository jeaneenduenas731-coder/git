...
/********************************************************************
 * @brief	AVRCP Initial.
 * @param	params The AVRCP Feature
 * @return	True for the command implement successful
 * @Note 
 *******************************************************************/
bool AvrcpAppInit(AvrcpAppFeatures *appFeatures);
 ...
 *******************************************************************/
bool AvrcpConnect(uint8_t index, uint8_t * addr);
 ...
 *******************************************************************/
bool AvrcpDisconnect(uint8_t index);
 ...
 * @Note 
 *******************************************************************/
bool AvrcpCtrlPlay(uint8_t index);
 ...
 * @Note 
 ******************************************************************/
bool AvrcpCtrlPause(uint8_t index);
 ...
 * @Note 
 ******************************************************************/
bool AvrcpCtrlStop(uint8_t index);
 ...
 * @Note 
 ******************************************************************/
bool AvrcpCtrlNext(uint8_t index);
 ...
 * @Note 
 ******************************************************************/
bool AvrcpCtrlPrev(uint8_t index);
 ...
 * @Note 
 ******************************************************************/
bool AvrcpCtrlPressFastFoward(uint8_t index);
 ...
 * @Note 
 ******************************************************************/
bool AvrcpCtrlReleaseFastFoward(uint8_t index);
 ...
 * @Note 
 ******************************************************************/
bool AvrcpCtrlFastBackward(uint8_t index);
 ...
 * @Note 
 ******************************************************************/
bool AvrcpCtrlReleaseFastBackward(uint8_t index);
 ...
 ******************************************************************/
bool AvrcpCtrlGetPlayStatusInfo(uint8_t index);
 ...
 ******************************************************************/
bool AvrcpCtrlSetVolume(uint8_t index, uint8_t volumePercent);
 ...
 ******************************************************************/
bool AvrcpCtrlGetMediaInfo(uint8_t index);
 ...
 * @Note   
 ******************************************************************/
void AvrcpAdvTargetSyncVolumeConfig(uint8_t index,uint8_t volume);
...
//avrcp browse
/*******************************************************************
 * @brief	set brower player: 获取当前文件文件夹名称/深度
 * @param	playerId(default:1)
 * @return	success
 * @note	通过BT_STACK_EVENT_AVRCP_ADV_AVRCP_SET_BROWSER_PLAYER反馈数据
 ******************************************************************/
...
/*******************************************************************
 * @brief	get folder items: 获取当前文件夹内文件的信息
 * @param	startItem/endItem (保持一致,每次获取1个)
 * @return	success
 * @note	通过BT_STACK_EVENT_AVRCP_ADV_AVRCP_GET_FOLDER_ITEMS反馈数据
 ******************************************************************/
...
/*******************************************************************
 * @brief	change path: 改变文件目录
 * @param	direction: 0x01=down, 0x00=up
 * @param	uid:folder uid信息(进入下一个目录时有效,返回上一个目录时可以随意)
 * @return	success
 * @note	通过BT_STACK_EVENT_AVRCP_ADV_AVRCP_CHANGE_PATH反馈数据
 *
 ******************************************************************/
...
/*******************************************************************
 * @brief	play item: 通过UID信息播放歌曲
 * @param	uid: media element uid信息
 * @return	success
 * @note
 ******************************************************************/
