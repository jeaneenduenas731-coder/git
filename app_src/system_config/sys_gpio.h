...
//-----------register define-----------------------------------------------//
 ...
 // 		  TF卡，USB设备检测功能
 //****************************************************************************************
#if defined(CFG_APP_CARD_PLAY_MODE_EN)||defined(CFG_OTG_MODE_READER_EN)
...
/**ADC按键**/
	...
	#if 1//(CFG_CHIP_SEL==CFG_CHIP_BP1564A2)
		#define CFG_RES_ADC_KEY_PORT_CH1		ADC_CHANNEL_AD3_A28
		#define CFG_RES_ADC_KEY_CH1_ANA_EN		GPIO_A_ANA_EN
		#define CFG_RES_ADC_KEY_CH1_ANA_MASK	GPIO_INDEX28
		#define CFG_PARA_WAKEUP_GPIO_ADCKEY		WAKEUP_GPIOA28 //同步设置唤醒端口
