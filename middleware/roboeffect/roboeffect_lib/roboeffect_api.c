...
const roboeffect_effect_property_struct effect_property_for_robo[] = {
	...
	{ROBOEFFECT_NOISE_SUPPRESSOR_BLUE_ADV, ROBOEFFECT_CH_MONO, ROBOEFFECT_NOISE_SUPPRESSOR_BLUE_ADV_PARAM_LEN, FZ_GEAR, 4, {64,128,256,512},
#if NOISE_SUPPRESSOR_BLUE_ADV_ENABLE
	ROBOEFFECT_EFF_IF_NAME_INIT(noise_suppressor_blue_adv), ROBOEFFECT_EFF_IF_NAME_CONF(noise_suppressor_blue_adv), ROBOEFFECT_EFF_IF_NAME_APPLY(noise_suppressor_blue_adv), ROBOEFFECT_EFF_IF_NAME_MEMORY_SIZE(noise_suppressor_blue_adv),
#else
	ROBOEFFECT_EFF_IF_NAME_INIT(null), ROBOEFFECT_EFF_IF_NAME_CONF(null), ROBOEFFECT_EFF_IF_NAME_APPLY(null), ROBOEFFECT_EFF_IF_NAME_MEMORY_SIZE(null),
#endif/*NOISE_SUPPRESSOR_BLUE_ADV_ENABLE*/
	},
...
0x02, 0x24, 0x00, //roboeffect_library@2.36.0
0x02, 0x32, 0x03, //audio_effect_library@2.50.3
...
0x02, 0x03, 0x01, //pcm_delay@2.3.1
0x09, //effect name length
...
0x05, 0x00, 0x00, //beamforming@5.0.0
...
0x01, 0x04, 0x02, //noise_suppressor_blue_dual@1.4.2
...
0x02, 0x03, 0x01, //pcm_delay_ms@2.3.1
0x0C, //effect name length
...
0x00, //ui_layout is auto
/*****filter_fir end*****/
/*****noise_suppressor_blue_adv*****/
0x90, 0x00, //item len=144
0x04, 0x01, 0x00, //noise_suppressor_blue_adv@4.1.0
0x19, //effect name length
0x6E, 0x6F, 0x69, 0x73, 0x65, 0x5F, 0x73, 0x75, 0x70, 0x70, 0x72, 0x65, 0x73, 0x73, 0x6F, 0x72, 0x5F, 0x62, 0x6C, 0x75, 0x65, 0x5F, 0x61, 0x64, 0x76, //noise_suppressor_blue_adv
0x00, //effect category
0x02, //bits width is 16/24
0x10, //frame size formula length
0x7B, 0x36, 0x34, 0x2C, 0x31, 0x32, 0x38, 0x2C, 0x32, 0x35, 0x36, 0x2C, 0x35, 0x31, 0x32, 0x7D, //{64,128,256,512}
...
0x10, //index: 00, initial_env_time
0x69, 0x6E, 0x69, 0x74, 0x69, 0x61, 0x6C, 0x5F, 0x65, 0x6E, 0x76, 0x5F, 0x74, 0x69, 0x6D, 0x65, 
0x02, //value: value
0x0A, 0x00, //min 10
0x88, 0x13, //max 5000
0x01, 0x00, //step 1
...
0x0B, //index: 01, smooth_time
0x73, 0x6D, 0x6F, 0x6F, 0x74, 0x68, 0x5F, 0x74, 0x69, 0x6D, 0x65, 
0x02, //value: value
0x01, 0x00, //min 1
0xFF, 0x7F, //max 32767
0x01, 0x00, //step 1
...
{
    return sizeof(effect_property_for_display);// 15646 bytes
}
